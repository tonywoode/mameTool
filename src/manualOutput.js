...
module.exports = (emu, mameJson, winIconDir, outputDir) => {
    ...
    makeSplit(`genre`, `${outputDir}/full/allGames`, emu, winIconDir, mameJson)

    makeSplit(`genre`, `${outputDir}/noMature/allGames`, emu, winIconDir, noMatureJson)

    makeSplit(`genre`, `${outputDir}/full/workingOnly`, emu, winIconDir, noPreliminaryFullJson)

    makeSplit(`genre`, `${outputDir}/noMature/workingOnly`, emu, winIconDir, noPreliminaryNoMatureJson)
